...
export default function STRAMARKDashboardShell() {
                ...
                <div className="flex flex-col border-b border-border p-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span className="ml-2 rounded-full bg-orange-100 px-2 py-0.5 text-[10px] font-semibold text-orange-600">Pilot</span>
                        </div>
                    </div>
