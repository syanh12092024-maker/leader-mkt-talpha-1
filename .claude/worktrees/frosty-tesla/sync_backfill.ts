import { TAlphaAdsModel } from "./src/lib/bigquery/models/talpha-ads.model";
import { GoogleSheetsSyncService } from "./src/lib/google-sheets/services/talpha-sync.service";
...
async function backfill() {
    ...
    for (const date of dates) {
        try {
            ...
            console.log(`✅ ${date}: Success (Spend: ${result.total_spend} VND, Orders: ${result.total_orders})`);
        } catch (err: any) {
