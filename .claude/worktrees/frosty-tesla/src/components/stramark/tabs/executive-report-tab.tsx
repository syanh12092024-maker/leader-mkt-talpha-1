                                ...
                                {leaderboard.map((m: any, i: number) => (
                                    <tr key={i}>
                                        <td className="px-3 py-3 font-medium text-foreground">
                                            {i === 0 ? '≡ƒÑç' : i === 1 ? '≡ƒÑê' : ''} {m.marketer_name}
                                        </td>
...
// formatCurrency imported from @/lib/utils ΓÇö converts RONΓåÆVND with compact format
