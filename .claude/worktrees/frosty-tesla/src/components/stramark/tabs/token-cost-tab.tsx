...
// ΓöÇΓöÇ API Base ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Realtime monitoring ΓÇö OpenAI GPT-4o-mini
                            </p>
                        </div>
                        <button
                            onClick={fetchData}
                    ...
                    <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="font-medium text-emerald-400">OpenAI Prompt Caching ΓÇö Active</h3>
                                <p className="text-xs text-muted-foreground">
                                    System prompts ({">"}1024 tokens) tß╗▒ ─æß╗Öng cached, giß║úm 50% input cost.
                                    GPT-4o-mini: $0.15/M input ΓåÆ $0.075/M cached.
                                </p>
                            </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <div className="rounded-xl border border-border bg-card p-5">
                            ...
                            {Object.keys(agentMap).length === 0 ? (
                                <p className="text-sm text-muted-foreground">Ch╞░a c├│ dß╗» liß╗çu. Chß║íy mß╗Öt meeting ─æß╗â bß║»t ─æß║ºu tracking.</p>
                            ) : (
                                            ...
                                            <div key={agent} className="flex items-center justify-between">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-muted-foreground">
                                                            {data.runs} runs ΓÇó {Math.round(data.tokens).toLocaleString()} tokens
                                                        </p>
                                                    </div>
                                                </div>
                        ...
                        <div className="rounded-xl border border-border bg-card p-5">
                            ...
                            {runs.length === 0 ? (
                                <p className="text-sm text-muted-foreground">Ch╞░a c├│ dß╗» liß╗çu.</p>
                            ) : (
                                        ...
                                        >
                                            <div>
                                                ...
                                                <p className="mt-1 text-xs text-muted-foreground">
                                                    {run.agents_used.join(", ")} ΓÇó {run.tokens.total.toLocaleString()} tokens
                                                    {run.tokens.cached > 0 && (
                    ...
                    {/* Pricing Reference */}
                    <div className="rounded-xl border border-border bg-card p-5">
                        <h3 className="mb-3 text-sm font-semibold text-foreground">Pricing Reference ΓÇö GPT-4o-mini</h3>
...
// ΓöÇΓöÇ KPI Card Component ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
